        ...
        public GetFromName(string name)
        {
            ...
            switch (name)
            {
                ...
                case "案件信息":
                    ...
                    bmpName = "anjian";
                    xiaquField = "发案地点_街道";
                    sqlFields = "案件名称,案件编号,案发状态,案件类型,案别_案由,简要案情,专案标识,发案时间初值,发案时间终值,发案地点_区县,发案地点_街道,所属社区,发案地点详址,发案场所,案件来源,作案手段特点,所属派出所代码,所属中队代码,所属警务室代码,涉案人员,抽取ID,抽取更新时间,最后更新人,所属派出所,所属中队,所属警务室,标注人,标注时间,t.geoloc.SDO_POINT.X as X,t.geoloc.SDO_POINT.Y as Y";
                    break;
                case "公共场所":
                    objName = "企业实际经营名称";
                    objID = "编号";
