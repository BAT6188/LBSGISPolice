        ...
        public GetFromName(string name) {
            ...
            switch (name)
            {
                ...
                case "案件信息":
                    ...
                    bmpName = "anjian";
                    xiaquField = "发案地点_街道";
                    sqlFields = "案件名称,案件编号,案发状态,案件类型,案别_案由,简要案情,专案标识,发案时间初值,发案时间终值,发案地点_区县,发案地点_街道,所属社区,发案地点详址,发案场所,t.geoloc.SDO_POINT.X as X,t.geoloc.SDO_POINT.Y as Y";
                    break;
                case "公共场所":
                    objName = "企业实际经营名称";
                    objID = "编号";
