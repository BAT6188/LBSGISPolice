...
namespace LBSgisPolice
{
    public class DataMethod
	{
        ...
        /// <returns></returns>
        public static string generateSql(string statType, string type, string typeName, string groupName, string fieldName, string tableName, string innerJoin, string where, string sumType)
        {
            string condition = "";
            ...
            {
                condition = generateSelect(type, typeName, fieldName, tableName, where);
            }
            if (condition != "")
            {
        ...
        /// <returns></returns>
        public static string generateSelect(string type, string typeName, string fieldName, string tableName, string where)
        {
            string text = "";
