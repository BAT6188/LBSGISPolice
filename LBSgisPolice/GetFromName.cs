        ...
        public GetFromName(string name) {
            ...
            switch (name)
            {
                ...
                case "人口系统":
                    ...
                    tableName = "人口系统";
                    bmpName = "ren.bmp";
                    sqlFields = "姓名,身份证号码,民族,性别,人口性质,出生日期,全住址,住址街路巷,住址门牌,楼层,房间号,户籍地址,婚姻状态,配偶姓名,结婚时间,交通工具,车牌号码,服务处所,政治面貌, 暂住证号,暂住证有效期限,入住日期,注销日期,联系电话,重点人口,所属派出所,t.geoloc.SDO_POINT.X as X,t.geoloc.SDO_POINT.Y as Y";
                    xiaquField = "所属派出所";
                    break;
                case "安全防护单位":
                    objName = "单位名称";
